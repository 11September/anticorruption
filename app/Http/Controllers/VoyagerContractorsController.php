...
class VoyagerContractorsController extends Controller
{
...
//        dd($dataTypeContent);
    ...
    public function show(Request $request, $id)
    {
        ...
        return view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'comments', 'documents'));
    }
...
//        $val = $this->validateBread($request->all(), $dataType->editRows);
        ...
        $val = Validator::make($request->all(), [
            'name' => 'required|exists:contractors',
            'identification_contractor' => 'required|unique:contractors',
        ]);
...
//            $this->insertUpdateData($request, $slug, $dataType->editRows, $data);
            ...
            $contractor->identification_contractor = $request->identification_contractor;

            $contractor->save();

            $redirectId = $contractor->id;
